...
!function (a) {
    ...
    c.prototype.init = function (b) {
        ...
        function e(c, d, e) {
            ...
            if (e)b.showTooltip(e, f.tooltipOptions.snap ? e : d); else if (f.plotOptions.series.lines.show && f.tooltipOptions.lines === !0) {
                ...
                a.each(b.getData(), function (a, c) {
                    ...
                    var m = {x: c.data[e][0], y: c.data[e][1]}, n = {
                        x: c.data[i][0],
                        y: c.data[i][1]
                    }, o = h(c.xaxis.p2c(d.x), c.yaxis.p2c(d.y), c.xaxis.p2c(m.x), c.yaxis.p2c(m.y), c.xaxis.p2c(n.x), c.yaxis.p2c(n.y), !1);
                    if (o < j.distance) {
                        var p = g(m.x, m.y, d.x, d.y) < g(d.x, d.y, n.x, n.y) ? e : i, q = (c.datapoints.pointsize, [d.x, m.y + (n.y - m.y) * ((d.x - m.x) / (n.x - m.x))]), r = {
                            datapoint: q,
                            dataIndex: p,
                            series: c,
                            seriesIndex: a
        ...
        b.hooks.bindEvents.push(function (b, g) {
            ...
            var c = f.getDomElement(), d = c.outerWidth() + f.tooltipOptions.shifts.x, e = c.outerHeight() + f.tooltipOptions.shifts.y;
